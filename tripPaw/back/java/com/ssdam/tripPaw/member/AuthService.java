...
//    }
    public Map<String, String> login(MemberLoginForm request) {
        System.out.println("입력한 username: " + request.getEmail());
...
//                .orElseThrow(() -> new UsernameNotFoundException("User not found: " + request.getUsername()));
       ...
       // member.getRole().add(memberMapper.findMemberRoleTypeByMemberId(member.getId()));
        ...
        redisUtil.saveRefreshToken(member.getEmail(), refreshToken, 1209600000L);
...
//        }
     ...
     //   Authentication authentication = jwtProvider.getAuthentication(accessToken);
    	...
    	System.out.println("logoutEmail="+email);
